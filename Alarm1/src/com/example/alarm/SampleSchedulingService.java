...
public class SampleSchedulingService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		// If the app finds the string "doodle" in the Google home page content,
		// it
		// indicates the presence of a doodle. Post a "Doodle Alert"
		// notification.
	...
	//
	// The methods below this line fetch content from the specified URL and
	// return the
	// content as a string.
	//
